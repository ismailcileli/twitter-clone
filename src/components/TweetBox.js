  ...
  const sendTweet = () => {
    if (content !== "") {
      db.collection("feed").add({
        ...
        avatar:
          "https://media-exp1.licdn.com/dms/image/C4D03AQGYc8ac9_ZKug/profile-displayphoto-shrink_200_200/0/1596629183214?e=1634774400&v=beta&t=eBci5B-eX9CPZizmYjvyQfbnCJwo0iu2B4Xbva29O6k",
      });
      setContent("");
    }
  };
  return (
    <div className="flex-1 flex flex-col mt-2 px-2">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          className="bg-primary-base text-white rounded-full px-4 py-2 font-medium hover:bg-primary-dark"
          onClick={sendTweet}
        >
          Tweet
        </button>
